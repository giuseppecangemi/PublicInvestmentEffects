...
\title{Moltiplicatori dell'investimento pubblico e corruzione:\\
...
\begin{abstract}
Questo articolo combina un esercizio di replicazione con un’estensione metodologica: da un lato replico le evidenze recenti sui moltiplicatori dell’investimento pubblico nell’Unione Europea, dall’altro valuto se e in che misura la loro efficacia dipenda dalla qualità delle istituzioni, approssimata dal livello di corruzione.
\end{abstract}
...
\section{Il lavoro originale: idea e strategia di identificazione}

\subsection{Shock di investimento pubblico tramite errori di previsione}
...
\section{Replicazione: perché è importante}
...
\section{Risultati di base: interpretazione e contesto economico}
...
\subsection{L'impatto della spesa sul PIL reale}
...
\subsection{Investimento privato: crowding-in o crowding-out?}
...
\subsection{Debito pubblico: un'eterna questione}
...
\subsection{La spesa pubblica favorisce il mercato del lavoro? }
...
\subsection{Sintesi dei risultati di base}
...
\begin{figure}[h!]
  ...
  \begin{subfigure}{0.4\textwidth}
    \centering
    \includegraphics[width=\linewidth]{/Users/giuseppecangemi/Desktop/Programming/Python/PUBLIC_INVESTMENT/graphs/BASELINE/gdp.png}
    \caption{PIL reale: moltiplicatore cumulato dell'investimento pubblico}
    \label{fig:gdp}
  \end{subfigure}
  %--- Alto destra ---
  \begin{subfigure}{0.4\textwidth}
    \centering
    \includegraphics[width=\linewidth]{/Users/giuseppecangemi/Desktop/Programming/Python/PUBLIC_INVESTMENT/graphs/BASELINE/private_investment.png}
    \caption{Investimento privato: risposta cumulata}
    \label{fig:private_investment}
  \end{subfigure}
  ...
  \begin{subfigure}{0.4\textwidth}
    \centering
    \includegraphics[width=\linewidth]{/Users/giuseppecangemi/Desktop/Programming/Python/PUBLIC_INVESTMENT/graphs/BASELINE/public_debt.png}
    \caption{Rapporto debito/PIL: risposta cumulata}
    \label{fig:public_debt}
  \end{subfigure}
  %--- Basso destra ---
  \begin{subfigure}{0.4\textwidth}
    \centering
    \includegraphics[width=\linewidth]{/Users/giuseppecangemi/Desktop/Programming/Python/PUBLIC_INVESTMENT/graphs/BASELINE/unemployment.png}
    \caption{Tasso di disoccupazione: risposta cumulata}
    \label{fig:unemployment}
  \end{subfigure}

  \caption{Effetti macroeconomici dell'investimento pubblico}
  \label{fig:public_investment_4panels}
\end{figure}


\newpage
\section{Domanda di ricerca: la corruzione conta?}
...
\subsection*{Evidenza dalla letteratura su corruzione e attività economica}
...
\subsection*{Dati sulla corruzione: Worldwide Governance Indicators}

Per misurare la qualità istituzionale, questo studio utilizza i \emph{Worldwide Governance Indicators (WGI)} prodotti dal \emph{World Bank Group}. I WGI sono un dataset globale ampiamente utilizzato, che copre oltre 200 economie su base annua dal 1996, riassumendo diverse fonti di percezioni sulla governance in sei indicatori compositi. Una di queste dimensioni, il \emph{Control of Corruption}, cattura la misura in cui il potere pubblico è esercitato per fini privati, includendo forme di corruzione sia di piccola scala sia \emph{grand corruption}, nonché fenomeni di \emph{state capture} da parte di élite e interessi privati.
...
\section{Estensione metodologica: introduzione delle interazioni con la corruzione}

\subsection{Specifica estesa}
...
\section{Risultati estesi: paesi ad alta e bassa corruzione}
...
\subsection{Effetti sull'investimento privato}
...
\begin{center}
[Figura 2 - Investimento privato]
\end{center}



\subsection{Il solito debito}
...
\begin{center}
[Figura 2 - Debito pubblico]
\end{center}


\subsection{Effetti sul mercato del lavoro}
...
\begin{center}
[Figura 2 - Disoccupazione]
\end{center}


\begin{figure}% [p] per favorire una pagina intera di figure
  \centering
  \begin{tabular}{cc}

    % --- Riga 1: PIL ---
    \includegraphics[width=0.35\textwidth]{/Users/giuseppecangemi/Desktop/Programming/Python/PUBLIC_INVESTMENT/graphs/CORRUPTION/gdp_high.png} &
    \includegraphics[width=0.35\textwidth]{/Users/giuseppecangemi/Desktop/Programming/Python/PUBLIC_INVESTMENT/graphs/CORRUPTION/gdp_low.png} \\
    \emph{PIL -- alta corruzione} & \emph{PIL -- bassa corruzione} \\[0.8em]

    % --- Riga 2: Investimento privato ---
    \includegraphics[width=0.35\textwidth]{/Users/giuseppecangemi/Desktop/Programming/Python/PUBLIC_INVESTMENT/graphs/CORRUPTION/private_investment_high.png} &
    \includegraphics[width=0.35\textwidth]{/Users/giuseppecangemi/Desktop/Programming/Python/PUBLIC_INVESTMENT/graphs/CORRUPTION/private_investment_low.png} \\
    \emph{Investimento privato -- alta corruzione} & \emph{Investimento privato -- bassa corruzione} \\[0.8em]

    % --- Riga 3: Debito pubblico ---
    \includegraphics[width=0.35\textwidth]{/Users/giuseppecangemi/Desktop/Programming/Python/PUBLIC_INVESTMENT/graphs/CORRUPTION/public_debt_high.png} &
    \includegraphics[width=0.35\textwidth]{/Users/giuseppecangemi/Desktop/Programming/Python/PUBLIC_INVESTMENT/graphs/CORRUPTION/public_debt_low.png} \\
    \emph{Debito pubblico -- alta corruzione} & \emph{Debito pubblico -- bassa corruzione} \\[0.8em]

    % --- Riga 4: Disoccupazione ---
    \includegraphics[width=0.35\textwidth]{/Users/giuseppecangemi/Desktop/Programming/Python/PUBLIC_INVESTMENT/graphs/CORRUPTION/unemployment_high.png} &
    \includegraphics[width=0.35\textwidth]{/Users/giuseppecangemi/Desktop/Programming/Python/PUBLIC_INVESTMENT/graphs/CORRUPTION/unemployment_low.png} \\
    \emph{Disoccupazione -- alta corruzione} & \emph{Disoccupazione -- bassa corruzione}

  \end{tabular}
  \caption{Risposte cumulate delle variabili macroeconomiche a uno shock di investimento pubblico: alta vs bassa corruzione}
  \label{fig:corruption_8panels}
\end{figure}
...
\emph{American Economic Review}, 90(1), 194–211.

Aschauer, D. A. (1989).
Is public expenditure productive?
\emph{Journal of Monetary Economics}, 23(2), 177–200.
...
\emph{Journal of Economic Surveys}, 28(5), 889–916.
...
\emph{Applied Economics Letters}.
...
\emph{Journal of Monetary Economics}, 57(8), 1000–1012.

Mauro, P. (1995).
Corruption and growth.
\emph{Quarterly Journal of Economics}, 110(3), 681–712.

Méon, P.-G., \& Sekkat, K. (2005).
Does corruption grease or sand the wheels of growth?
\emph{Public Choice}, 122(1–2), 69–97.

Ramey, V. A. (2011).
Identifying government spending shocks: It’s all in the timing.
\emph{Quarterly Journal of Economics}, 126(1), 1–50.

Shleifer, A., \& Vishny, R. W. (1993).
Corruption.
\emph{Quarterly Journal of Economics}, 108(3), 599–617.

Tanzi, V., \& Davoodi, H. (1997).
Corruption, public investment, and growth.
\emph{IMF Working Paper}, WP/97/139.

Wei, S.-J. (2000).
How taxing is corruption on international investors?
\emph{Review of Economics and Statistics}, 82(1), 1–11.
